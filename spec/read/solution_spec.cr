  ...
  context "reads BMP file" do
    context "spec/images/solution.bmp" do
      ...
      context "row 0" do
        ...
        it "col 2" { expect(canvas.get(2, 0)).to eq(StumpyCore::RGBA.from_rgb8(0, 0, 0)) }
        it "col 3" { expect(canvas.get(3, 0)).to eq(StumpyCore::RGBA.from_rgb8(146, 80, 0)) }
      ...
      context "row 1" do
        ...
        it "col 2" { expect(canvas.get(2, 1)).to eq(StumpyCore::RGBA.from_rgb8(28, 0, 0)) }
        it "col 3" { expect(canvas.get(3, 1)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 1)) }
      ...
      context "row 2" do
        ...
        it "col 2" { expect(canvas.get(2, 2)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 2)) }
        it "col 3" { expect(canvas.get(3, 2)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 0)) }
      ...
      context "row 3" do
        ...
        it "col 2" { expect(canvas.get(2, 3)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 3)) }
        it "col 3" { expect(canvas.get(3, 3)).to eq(StumpyCore::RGBA.from_rgb8(112, 137, 12)) }
      ...
      context "row 4" do
        ...
        it "col 2" { expect(canvas.get(2, 4)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 2)) }
        it "col 3" { expect(canvas.get(3, 4)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 2)) }
      ...
      context "row 5" do
        ...
        it "col 2" { expect(canvas.get(2, 5)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 2)) }
        it "col 3" { expect(canvas.get(3, 5)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 2)) }
      ...
      context "row 6" do
        ...
        it "col 2" { expect(canvas.get(2, 6)).to eq(StumpyCore::RGBA.from_rgb8(112, 73, 76)) }
        it "col 3" { expect(canvas.get(3, 6)).to eq(StumpyCore::RGBA.from_rgb8(0, 0, 0)) }
      ...
      context "row 7" do
        ...
        it "col 2" { expect(canvas.get(2, 7)).to eq(StumpyCore::RGBA.from_rgb8(255, 255, 255)) }
        it "col 3" { expect(canvas.get(3, 7)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 1)) }
      ...
      context "row 8" do
        ...
        it "col 2" { expect(canvas.get(2, 8)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 1)) }
        it "col 3" { expect(canvas.get(3, 8)).to eq(StumpyCore::RGBA.from_rgb8(112, 33, 4)) }
      ...
      context "row 9" do
        ...
        it "col 2" { expect(canvas.get(2, 9)).to eq(StumpyCore::RGBA.from_rgb8(255, 255, 255)) }
        it "col 3" { expect(canvas.get(3, 9)).to eq(StumpyCore::RGBA.from_rgb8(0, 0, 0)) }
        it "col 4" { expect(canvas.get(4, 9)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 1)) }
        it "col 5" { expect(canvas.get(5, 9)).to eq(StumpyCore::RGBA.from_rgb8(48, 0, 0)) }
      end
    end
  end
end
